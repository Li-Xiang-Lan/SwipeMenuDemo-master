...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void findview() {
        ...
        mMainSwipemenu= (SwipeMenu) findViewById(R.id.main_swipemenu);
        mRgTrans= (RadioGroup) findViewById(R.id.menu_rg_trans);
        mCbScale= (CheckBox) findViewById(R.id.menu_cb_scale);
        mSbScale= (SeekBar) findViewById(R.id.menu_sb_scale);
        mCbAlpha= (CheckBox) findViewById(R.id.menu_cb_alpha);
        mSbAlpha= (SeekBar) findViewById(R.id.menu_sb_alpha);
        mRgRotate= (RadioGroup) findViewById(R.id.menu_rg_rotate);
        mSbRotate= (SeekBar) findViewById(R.id.menu_Sb_rotate);
        mBtnMenu= (ImageButton) findViewById(R.id.main_btn_menu);
        mContentRecyclerView= (RecyclerView) findViewById(R.id.content_recyclerView);
        mCbPic= (CheckBox) findViewById(R.id.cb_pic);
        mContentRgBlur= (RadioGroup) findViewById(R.id.content_rg_blur);
    }
